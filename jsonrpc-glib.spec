...
Version  : 3.32.0
Release  : 1
URL      : https://github.com/GNOME/jsonrpc-glib/archive/3.32.0.tar.gz
Source0  : https://github.com/GNOME/jsonrpc-glib/archive/3.32.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1552659410
...
/usr/lib64/libjsonrpc-glib-1.0.so.1.3200.0
